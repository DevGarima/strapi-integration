...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTASection: Schema.Attribute.Component<'shared.cta-section', true>;
    FeatureSection: Schema.Attribute.Component<'shared.feature-section', true>;
    home: Schema.Attribute.Component<'shared.home', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHeaderFooterHeaderFooter
  extends Struct.CollectionTypeSchema {
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderStatus: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    shopifyId: Schema.Attribute.String & Schema.Attribute.Required;
    size: Schema.Attribute.Enumeration<['xs', 'sm', 'md', 'lg', 'xxl']>;
    slug: Schema.Attribute.UID<'title'>;
